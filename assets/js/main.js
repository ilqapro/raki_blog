$(function() {
  ...
  function change_product_content_tab(need_tab = false) {
    $('#product_content .tabs .active').removeClass('active')
    if( need_tab ) {
      let tab = $(need_tab).data('active')
      $(need_tab).addClass('active')
      $('.product_content-item.' + tab).addClass('active')
    } else {
      $('#product_content .tabs').each(function() {
        $(this).find('> *').first().addClass('active')
      })
    }
  }

  change_product_content_tab()

  $('.product_content-menu button').click(function() {
    change_product_content_tab($(this))
  })
